...
export default function Hero({
  title = "Professional Timing Control for Every Stage",
  description = "From conferences to theaters, broadcast studios to classrooms. DYTOR delivers drift-free synchronization and role-based control that keeps your productions running flawlessly & adapts to your team.",
  mockup = (
    <Screenshot
  ...
  return (
    <Section
      className={cn(
        "fade-bottom overflow-hidden pt-0 pb-0 sm:pt-0 sm:pb-0 md:pt-0 md:pb-0",
        className,
      )}
    >
