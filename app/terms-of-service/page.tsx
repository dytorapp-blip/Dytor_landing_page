...
export default function TermsOfServicePage() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <h2 className="text-2xl font-semibold mb-3 mt-6">Accounts</h2>
      ...
      <h2 className="text-2xl font-semibold mb-3 mt-6">Links To Other Web Sites</h2>
      <p className="mb-4">Our Service may contain links to third-party web sites or services that are not owned or controlled by Dytor.react.</p>

      <p className="mb-4">Dytor.react has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that Dytor.react shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with use of or reliance on any such content, goods or services available on or through any such web sites or services.</p>
      ...
      <h2 className="text-2xl font-semibold mb-3 mt-6">Termination</h2>
      ...
      <h2 className="text-2xl font-semibold mb-3 mt-6">Governing Law</h2>
      ...
      <h2 className="text-2xl font-semibold mb-3 mt-6">Changes</h2>
      ...
      <ul className="list-disc list-inside mb-4 pl-4">
        <li>By email: dytor.app@gmail.com</li>
        <li>By visiting this page on our website: dytor.app</li>
      </ul>
    </div>
  );
}
