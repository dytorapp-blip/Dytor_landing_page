...
export default function PrivacyPolicyPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <h2 className="text-2xl font-semibold mb-3 mt-6">Interpretation and Definitions</h2>

      <h3 className="text-xl font-semibold mb-2 mt-4">Interpretation</h3>
      ...
      <h2 className="text-2xl font-semibold mb-3 mt-6">Collecting and Using Your Personal Data</h2>

      <h3 className="text-xl font-semibold mb-2 mt-4">Types of Data Collected</h3>
      ...
      <h3 className="text-xl font-semibold mb-2 mt-4">Use of Your Personal Data</h3>
      ...
      <h3 className="text-xl font-semibold mb-2 mt-4">Retention of Your Personal Data</h3>
      ...
      <h3 className="text-xl font-semibold mb-2 mt-4">Transfer of Your Personal Data</h3>
      ...
      <h3 className="text-xl font-semibold mb-2 mt-4">Disclosure of Your Personal Data</h3>
      ...
      <h3 className="text-xl font-semibold mb-2 mt-4">Security of Your Personal Data</h3>
      <p className="mb-4">The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>

      <h2 className="text-2xl font-semibold mb-3 mt-6">Children's Privacy</h2>
      ...
      <h2 className="text-2xl font-semibold mb-3 mt-6">Links to Other Websites</h2>
      ...
      <h2 className="text-2xl font-semibold mb-3 mt-6">Changes to this Privacy Policy</h2>
